...
// Label variables for rules view
...
//  Configuring Rules Label
    func configureRulesLabel() {
        view.addSubview(rulesLabel)
        rulesLabel.translatesAutoresizingMaskIntoConstraints = false
        rulesLabel.text = "The value of each card represents the number of excersie you do \n\nJ = 11, Q = 12, K = 13, A = 14"
...
//Custom Constraint
    ...
    //  Configuring excersise Label
        func configureExcersieLabel() {
